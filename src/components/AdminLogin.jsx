        ...
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='mb-4 '>
                    ...
                    type="text" name="username" id="email" placeholder='username' className='shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow'/>
                </div>
                <div className='mb-4 '>
